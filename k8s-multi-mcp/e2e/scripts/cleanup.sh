...
PROJECTS=("cryostat-multi-mcp" "c1" "apps1" "c2" "apps2")
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    IMAGES=(
        "default-route-openshift-image-registry.apps-crc.testing/cryostat-multi-mcp/cryostat-k8s-multi-mcp:latest"
    )
